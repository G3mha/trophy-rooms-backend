/* eslint-disable */
import type { Prisma, User, Platform, Game, AchievementSet, Achievement, UserAchievement, Trophy, Wishlist } from "@prisma/client";
...
export default interface PrismaTypes {
    User: {
        ...
        Create: {};
        Update: {};
        RelationName: "achievements" | "trophies" | "wishlist" | "achievementSets";
        ListRelations: "achievements" | "trophies" | "wishlist" | "achievementSets";
        Relations: {
            achievements: {
    ...
    Game: {
        ...
        Create: {};
        Update: {};
        RelationName: "platform" | "achievementSets" | "trophies" | "wishlistedBy";
        ListRelations: "achievementSets" | "trophies" | "wishlistedBy";
        Relations: {
            platform: {
                Shape: Platform | null;
                Name: "Platform";
