/* eslint-disable */
import type { Prisma, User, Platform, Game, AchievementSet, Achievement, UserAchievement, Trophy, UserGame, CollectionItem } from "@prisma/client";
...
export default interface PrismaTypes {
    User: {
        ...
        Create: {};
        Update: {};
        RelationName: "achievements" | "trophies" | "userGames" | "collectionItems" | "achievementSets";
        ListRelations: "achievements" | "trophies" | "userGames" | "collectionItems" | "achievementSets";
        Relations: {
            achievements: {
    ...
    Platform: {
        ...
        Create: {};
        Update: {};
        RelationName: "games" | "collectionItems";
        ListRelations: "games" | "collectionItems";
        Relations: {
            games: {
                Shape: Game[];
                Name: "Game";
    ...
    Game: {
        ...
        Create: {};
        Update: {};
        RelationName: "platform" | "achievementSets" | "trophies" | "userGames" | "collectionItems";
        ListRelations: "achievementSets" | "trophies" | "userGames" | "collectionItems";
        Relations: {
            platform: {
                Shape: Platform | null;
                Name: "Platform";
    ...
    CollectionItem: {
        ...
        Create: {};
        Update: {};
        RelationName: "user" | "game" | "platform";
        ListRelations: never;
        Relations: {
            user: {
                Shape: User;
