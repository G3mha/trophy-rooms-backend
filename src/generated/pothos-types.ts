/* eslint-disable */
import type { Prisma, User, Platform, Game, AchievementSet, Achievement, UserAchievement, Trophy, UserGame } from "@prisma/client";
...
export default interface PrismaTypes {
    User: {
        ...
        Create: {};
        Update: {};
        RelationName: "achievements" | "trophies" | "userGames" | "achievementSets";
        ListRelations: "achievements" | "trophies" | "userGames" | "achievementSets";
        Relations: {
            achievements: {
    ...
    Game: {
        ...
        Create: {};
        Update: {};
        RelationName: "platform" | "achievementSets" | "trophies" | "userGames";
        ListRelations: "achievementSets" | "trophies" | "userGames";
        Relations: {
            platform: {
                Shape: Platform | null;
                Name: "Platform";
