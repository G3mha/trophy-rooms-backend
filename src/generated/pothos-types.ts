/* eslint-disable */
import type { Prisma, User, Platform, PlatformRelease, GameFamily, Game, GameVersion, AchievementSet, Achievement, UserAchievement, Trophy, UserGame, CollectionItem, DLC, UserDLC, Bundle, UserBundle, BuylistItem } from "@prisma/client";
...
export default interface PrismaTypes {
    ...
    Platform: {
        ...
        Create: {};
        Update: {};
        RelationName: "games" | "bundles" | "collectionItems" | "userGames" | "userBundles" | "releases";
        ListRelations: "games" | "bundles" | "collectionItems" | "userGames" | "userBundles" | "releases";
        Relations: {
            games: {
                Shape: Game[];
                Name: "Game";
    ...
    Game: {
        ...
        Create: {};
        Update: {};
        RelationName: "gameFamily" | "platform" | "trophies" | "userGames" | "collectionItems" | "versions" | "buylistItems";
        ListRelations: "trophies" | "userGames" | "collectionItems" | "versions" | "buylistItems";
        Relations: {
            gameFamily: {
    ...
    DLC: {
        ...
        Create: {};
        Update: {};
        RelationName: "gameFamily" | "achievementSets" | "gameVersions" | "bundles" | "userDlcs" | "buylistItems";
    ...
    Bundle: {
        ...
        Create: {};
        Update: {};
        RelationName: "platform" | "gameFamilies" | "dlcs" | "userBundles" | "buylistItems";
        ListRelations: "gameFamilies" | "dlcs" | "userBundles" | "buylistItems";
        Relations: {
            platform: {
                Shape: Platform | null;
                Name: "Platform";
    ...
    UserBundle: {
        ...
        Create: {};
        Update: {};
        RelationName: "user" | "bundle" | "platform";
        ListRelations: never;
        Relations: {
            user: {
                Shape: User;
