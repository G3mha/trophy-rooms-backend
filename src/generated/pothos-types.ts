...
export default interface PrismaTypes {
    ...
    Platform: {
        ...
        Create: {};
        Update: {};
        RelationName: "games" | "bundles" | "collectionItems" | "userGames" | "releases";
        ListRelations: "games" | "bundles" | "collectionItems" | "userGames" | "releases";
        Relations: {
            games: {
                Shape: Game[];
                Name: "Game";
